...
#define __imx8m_clk_hw_composite_sai(name, parent_names, reg, flags) \
	imx8m_clk_hw_composite_flags(name, parent_names, \
		ARRAY_SIZE(parent_names), reg, IMX_COMPOSITE_SAI, \
		flags | CLK_SET_RATE_NO_REPARENT | CLK_OPS_PARENT_ENABLE)
...
#define imx8m_clk_hw_composite_sai(name, parent_names, reg) \
	__imx8m_clk_hw_composite_sai(name, parent_names, reg, 0)
