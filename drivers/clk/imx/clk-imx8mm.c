...
static const struct imx_int_pll_rate_table imx8mm_intpll_tbl[] = {
	 ...
	 * in `clk-intpll.c` works correctly.
	 */
...
static void __init imx8mm_clocks_init(struct device_node *ccm_node)
{
	...
	clks[IMX8MM_CLK_SAI1_PRE_DIV] = imx_clk_lazy_divider("sai1_pre_div", "sai1_cg", base + 0xa580, 16, 3);
	clks[IMX8MM_CLK_SAI2_PRE_DIV] = imx_clk_lazy_divider("sai2_pre_div", "sai2_cg", base + 0xa600, 16, 3);
	clks[IMX8MM_CLK_SAI3_PRE_DIV] = imx_clk_lazy_divider("sai3_pre_div", "sai3_cg", base + 0xa680, 16, 3);
	clks[IMX8MM_CLK_SAI4_PRE_DIV] = imx_clk_lazy_divider("sai4_pre_div", "sai4_cg", base + 0xa700, 16, 3);
	clks[IMX8MM_CLK_SAI5_PRE_DIV] = imx_clk_lazy_divider("sai5_pre_div", "sai5_cg", base + 0xa780, 16, 3);
	clks[IMX8MM_CLK_SAI6_PRE_DIV] = imx_clk_lazy_divider("sai6_pre_div", "sai6_cg", base + 0xa800, 16, 3);
	...
	clks[IMX8MM_CLK_SAI1_DIV] = imx_clk_lazy_divider("sai1_div", "sai1_pre_div", base + 0xa580, 0, 6);
	clks[IMX8MM_CLK_SAI2_DIV] = imx_clk_lazy_divider("sai2_div", "sai2_pre_div", base + 0xa600, 0, 6);
	clks[IMX8MM_CLK_SAI3_DIV] = imx_clk_lazy_divider("sai3_div", "sai3_pre_div", base + 0xa680, 0, 6);
	clks[IMX8MM_CLK_SAI4_DIV] = imx_clk_lazy_divider("sai4_div", "sai4_pre_div", base + 0xa700, 0, 6);
	clks[IMX8MM_CLK_SAI5_DIV] = imx_clk_lazy_divider("sai5_div", "sai5_pre_div", base + 0xa780, 0, 6);
	clks[IMX8MM_CLK_SAI6_DIV] = imx_clk_lazy_divider("sai6_div", "sai6_pre_div", base + 0xa800, 0, 6);
